      ...
      <div>
        ...
        <div className="flex items-center gap-4">
          <div className="text-center">
            <IconEdgeColor width={24} height={24} className="text-blue" />
            <p className="text-sm text-gray-dark mt-1">24x24</p>
          </div>
          <div className="text-center">
            <IconEdgeColor width={48} height={48} className="text-blue" />
            <p className="text-sm text-gray-dark mt-1">48x48</p>
          </div>
          <div className="text-center">
            <IconEdgeColor width={72} height={72} className="text-blue" />
            <p className="text-sm text-gray-dark mt-1">72x72</p>
          </div>
          <div className="text-center">
            <IconEdgeColor width={96} height={96} className="text-blue" />
