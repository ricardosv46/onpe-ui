  ...
  render: () => (
    <div className="space-y-6">
      <div>
        ...
        <div className="flex items-center gap-4">
          <div className="text-center">
            <IconMozillaColor width={24} height={24} className="text-onpe-ui-blue" />
            <p className="text-sm text-onpe-ui-gray-dark mt-1">24x24</p>
          </div>
          <div className="text-center">
            <IconMozillaColor width={48} height={48} className="text-onpe-ui-blue" />
            <p className="text-sm text-onpe-ui-gray-dark mt-1">48x48</p>
          </div>
          <div className="text-center">
            <IconMozillaColor width={72} height={72} className="text-onpe-ui-blue" />
            <p className="text-sm text-onpe-ui-gray-dark mt-1">72x72</p>
          </div>
          <div className="text-center">
            <IconMozillaColor width={96} height={96} className="text-onpe-ui-blue" />
      ...
      <div>
        ...
        <div className="flex items-center gap-4">
          <div className="text-center">
            <IconMozillaColor className="text-onpe-ui-blue" />
            <p className="text-sm text-onpe-ui-gray-dark mt-1">Azul</p>
          </div>
          <div className="text-center">
            <IconMozillaColor className="text-onpe-ui-skyblue" />
            <p className="text-sm text-onpe-ui-gray-dark mt-1">Skyblue</p>
          </div>
          <div className="text-center">
            <IconMozillaColor className="text-onpe-ui-red" />
            <p className="text-sm text-onpe-ui-gray-dark mt-1">Rojo</p>
          </div>
          <div className="text-center">
            <IconMozillaColor className="text-onpe-ui-gray" />
