  ...
  render: () => (
    <div className="space-y-6">
      <div>
        ...
        <div className="flex items-center gap-4">
          <div className="text-center">
            <IconChromeColor width={24} height={24} className="text-blue" />
            <p className="text-sm text-gray-dark mt-1">24x24</p>
          </div>
          <div className="text-center">
            <IconChromeColor width={48} height={48} className="text-blue" />
            <p className="text-sm text-gray-dark mt-1">48x48</p>
          </div>
          <div className="text-center">
            <IconChromeColor width={72} height={72} className="text-blue" />
            <p className="text-sm text-gray-dark mt-1">72x72</p>
          </div>
          <div className="text-center">
            <IconChromeColor width={96} height={96} className="text-blue" />
      ...
      <div>
        ...
        <div className="flex items-center gap-4">
          <div className="text-center">
            <IconChromeColor className="text-blue" />
            <p className="text-sm text-gray-dark mt-1">Azul</p>
          </div>
          <div className="text-center">
            <IconChromeColor className="text-skyblue" />
            <p className="text-sm text-gray-dark mt-1">Skyblue</p>
          </div>
          <div className="text-center">
            <IconChromeColor className="text-red" />
            <p className="text-sm text-gray-dark mt-1">Rojo</p>
          </div>
          <div className="text-center">
            <IconChromeColor className="text-gray" />
