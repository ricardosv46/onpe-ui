...
const meta: Meta<typeof IconChromeColor> = {
  title: "Icons/Logos/IconChromeColor",
  component: IconChromeColor,
  parameters: {
    layout: "centered",
  },
  tags: ["autodocs"],
  ...
  render: () => (
    <div className="space-y-6">
      <div>
        ...
        <div className="flex items-center gap-4">
          <div className="text-center">
            <IconChromeColor width={24} height={24} className="text-onpe-ui-blue" />
            <p className="text-sm text-onpe-ui-gray-dark mt-1">24x24</p>
          </div>
          <div className="text-center">
            <IconChromeColor width={48} height={48} className="text-onpe-ui-blue" />
            <p className="text-sm text-onpe-ui-gray-dark mt-1">48x48</p>
          </div>
          <div className="text-center">
            <IconChromeColor width={72} height={72} className="text-onpe-ui-blue" />
            <p className="text-sm text-onpe-ui-gray-dark mt-1">72x72</p>
          </div>
          <div className="text-center">
            <IconChromeColor width={96} height={96} className="text-onpe-ui-blue" />
      ...
      <div>
        ...
        <div className="flex items-center gap-4">
          <div className="text-center">
            <IconChromeColor className="text-onpe-ui-blue" />
            <p className="text-sm text-onpe-ui-gray-dark mt-1">Azul</p>
          </div>
          <div className="text-center">
            <IconChromeColor className="text-onpe-ui-skyblue" />
            <p className="text-sm text-onpe-ui-gray-dark mt-1">Skyblue</p>
          </div>
          <div className="text-center">
            <IconChromeColor className="text-onpe-ui-red" />
            <p className="text-sm text-onpe-ui-gray-dark mt-1">Rojo</p>
          </div>
          <div className="text-center">
            <IconChromeColor className="text-onpe-ui-gray" />
