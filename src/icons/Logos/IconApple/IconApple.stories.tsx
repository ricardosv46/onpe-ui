      ...
      <div>
        ...
        <div className="flex items-center gap-4">
          <div className="text-center">
            <IconApple width={16} height={16} className="text-blue" />
            <p className="text-sm text-gray-dark mt-1">16x16</p>
          </div>
          <div className="text-center">
            <IconApple width={24} height={24} className="text-blue" />
            <p className="text-sm text-gray-dark mt-1">24x24</p>
          </div>
          <div className="text-center">
            <IconApple width={32} height={32} className="text-blue" />
            <p className="text-sm text-gray-dark mt-1">32x32</p>
          </div>
          <div className="text-center">
            <IconApple width={48} height={48} className="text-blue" />
