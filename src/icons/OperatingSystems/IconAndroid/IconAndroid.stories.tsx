...
const meta: Meta<typeof IconAndroid> = {
  title: "Icons/Logos/IconAndroid",
      ...
      <div>
        ...
        <div className="flex items-center gap-4">
          <div className="text-center">
            <IconAndroid width={16} height={16} className="text-onpe-ui-blue" />
            <p className="text-sm text-onpe-ui-gray-dark mt-1">16x16</p>
          </div>
          <div className="text-center">
            <IconAndroid width={24} height={24} className="text-onpe-ui-blue" />
            <p className="text-sm text-onpe-ui-gray-dark mt-1">24x24</p>
          </div>
          <div className="text-center">
            <IconAndroid width={32} height={32} className="text-onpe-ui-blue" />
            <p className="text-sm text-onpe-ui-gray-dark mt-1">32x32</p>
          </div>
          <div className="text-center">
            <IconAndroid width={48} height={48} className="text-onpe-ui-blue" />
