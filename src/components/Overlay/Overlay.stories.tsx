...
export const Interactive: Story = {
  render: () => {
    ...
    return (
      <div className="relative min-h-screen bg-gray-extra-light p-8">
        <div className="max-w-md mx-auto bg-white rounded-lg shadow-lg p-6">
          <h2 className="text-xl font-bold text-blue mb-4">Demo de Overlay</h2>

          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-dark mb-2">Color del overlay:</label>
              <select
                value={selectedColor}
            ...
            <button
              ...
              className={`w-full py-2 px-4 rounded font-semibold transition-colors ${
                showOverlay ? "bg-red text-white hover:bg-red/80" : "bg-blue text-white hover:bg-blue/80"
              }`}
            >
          ...
          <div className="mt-6 p-4 bg-gray-extra-light rounded">
            <p className="text-sm text-gray-dark">Contenido de ejemplo que se ve detrás del overlay.</p>
          </div>
        </div>
    ...
    return (
      <div className="relative min-h-screen bg-white p-8">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-blue mb-6">Galería de Colores de Overlay</h2>

          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {colors.map((color) => (
              <div key={color.name} className="relative">
                <div className="bg-white border border-gray rounded-lg p-4 shadow">
                  <h3 className="font-semibold text-gray-dark mb-2">{color.label}</h3>
                  <div className="h-20 rounded bg-gray-extra-light flex items-center justify-center">
                    <span className="text-sm text-gray">Contenido de ejemplo</span>
                  </div>
                </div>
