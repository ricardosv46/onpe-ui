      ...
      <section className="flex flex-col gap-5 sm:gap-8 items-center mt-[18px] sm:mt-6 text-sm">
        ...
        <article className="flex flex-col sm:flex-row items-center sm:items-start gap-10 w-full">
          <div className="flex-1 w-full">
            ...
            <ul role="none" className="text-sm list-disc text-justify self-start pl-5">
              ...
              <li role="none" className="mb-2">
                <p tabIndex={0}>
                  ...
                  <span aria-hidden="true">Compatible solo con el lector del DNIe en PC, Mac o laptop.</span>
                </p>
              </li>
            </ul>
          </div>
              ...
              <li role="none" className="mb-2">
                <p tabIndex={0}>
                  ...
                  <span aria-hidden="true">
                    Compatibles con el lector del DNIe en PC, Mac o laptop y tecnología NFC (ISO 14443-B) en móviles.
                  </span>
                </p>
              </li>
            </ul>
